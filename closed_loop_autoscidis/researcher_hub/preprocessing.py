...
def digit_memory_trial_list_to_experiment_data(trial_sequence, debug=False):
    """
    ...
    Args:
        trial_sequence: List of trial dictionaries
    ...
    for idx, trial in enumerate(trial_sequence):
        ...
        if debug and idx < 3:  # Only print details for first few trials to avoid spam
